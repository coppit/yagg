...
[
	...
	{#State 1
		ACTIONS => {
			...
			'PERCENT_OUTPUT' => 5,
			'PERCENT_EXPECT' => 7,
			'PERCENT_TOKEN_TABLE' => 6,
			'PERCENT_PARSE_PARAM' => 8,
			'PERCENT_FILE_PREFIX' => 9,
			'PERCENT_UNION' => 11,
			'PERCENT_LEFT' => 13,
			'PERCENT_RIGHT' => 12,
			"%%" => 15,
			...
			'SEMICOLON' => 30,
			'PERCENT_LOCATIONS' => 29
		},
		GOTOS => {
			'symbol_declaration' => 19,
			'grammar_declaration' => 14,
			'precedence_declarator' => 4,
			'declaration' => 10,
			'precedence_declaration' => 26
		}
	},
	{#State 2
		ACTIONS => {
	...
	{#State 15
		...
		DEFAULT => -2,
		GOTOS => {
			'rules_or_grammar_declaration' => 37,
			'grammar' => 38,
			'rules' => 39
		}
	},
	...
	{#State 38
		...
		DEFAULT => -62,
		GOTOS => {
			'rules_or_grammar_declaration' => 58,
			'epilogue_opt' => 60,
			'rules' => 39
		}
	},
	...
	{#State 62
		ACTIONS => {
			...
			'BRACED_CODE' => -57,
			'STRING' => 50,
			'BRACED_CODE_WITH_BRACED_CODE_FOLLOWING' => 75,
			'IDENT' => 48
		},
		DEFAULT => -49,
		GOTOS => {
