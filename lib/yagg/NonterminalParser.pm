...
[
	...
	{#State 1
		ACTIONS => {
			...
			'PERCENT_NAME_PREFIX' => 8,
			'PERCENT_PURE_PARSER' => 9,
			'PROLOGUE' => 10,
			'PERCENT_FILE_PREFIX' => 14,
			'PERCENT_UNION' => 13,
			'PERCENT_TYPE' => 12,
			'PERCENT_LOCATIONS' => 16,
			"%%" => 17,
			'PERCENT_YACC' => 18,
			'PERCENT_NONASSOC' => 20,
			'PERCENT_DEBUG' => 21,
		...
		GOTOS => {
			'precedence_declarator' => 23,
			'declaration' => 15,
			'grammar_declaration' => 19,
			'symbol_declaration' => 11,
			'precedence_declaration' => 4
		}
	},
	{#State 2
		ACTIONS => {
	...
	{#State 17
		...
		GOTOS => {
			'rules' => 36,
			'grammar' => 39,
			'rules_or_grammar_declaration' => 38
		}
	},
	{#State 18
		DEFAULT => -19
	...
	{#State 39
		...
		GOTOS => {
			'rules' => 36,
			'epilogue_opt' => 61,
			'rules_or_grammar_declaration' => 59
		}
	},
	{#State 40
		ACTIONS => {
