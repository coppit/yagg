...
[
	...
	{#State 2
		ACTIONS => {
			"%%" => 28,
			'PERCENT_FILE_PREFIX' => 31,
			'PERCENT_START' => 27,
			'PERCENT_UNION' => 23,
			'PERCENT_OUTPUT' => 26,
			'PERCENT_DEFINES' => 24,
			'PERCENT_TOKEN_TABLE' => 25,
			'PERCENT_TOKEN' => 21,
			'PERCENT_NO_LINES' => 19,
			'PERCENT_RIGHT' => 18,
			'PERCENT_YACC' => 22,
			'PERCENT_PARSE_PARAM' => 12,
			'PERCENT_NAME_PREFIX' => 13,
			'PERCENT_TYPE' => 14,
			'PERCENT_EXPECT' => 16,
			'PERCENT_DEBUG' => 17,
			'PERCENT_LEFT' => 9,
			'PERCENT_LOCATIONS' => 11,
			'PERCENT_VERBOSE' => 10,
			'SEMICOLON' => 5,
			'PROLOGUE' => 4,
			'PERCENT_PURE_PARSER' => 7,
			'PERCENT_NONASSOC' => 6
		},
		GOTOS => {
			'precedence_declarator' => 20,
			'declaration' => 8,
			'grammar_declaration' => 29,
			'precedence_declaration' => 30,
			'symbol_declaration' => 15
		}
	},
	{#State 3
		DEFAULT => 0
	...
	{#State 28
		...
		GOTOS => {
			'grammar' => 50,
			'rules' => 48,
			'rules_or_grammar_declaration' => 47
		}
	},
	{#State 29
		DEFAULT => -5
